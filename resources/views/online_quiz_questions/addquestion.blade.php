        ...
        <div class="col-md-8">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form action="{{ route('savequestion',$quiz_id) }}" id="chapter_form" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                    
                        <div class="form-group">
                            <label for="question">Question</label>
                            <textarea name="question" id="question" cols="30" rows="2" class="form-control"></textarea>
                        </div>
                        ...
                        <!-- style="display:none" -->
                            <label for="online_quiz_id">online_quiz_id</label>
                            <input type="text" value="{{ $quiz_id }}" name="online_quiz_id" id="online_quiz_id" class="form-control"></textarea>
                        </div>
