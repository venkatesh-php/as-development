        ...
        <div class="col-md-8">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form action="{{ route('q2Update',['quiz_id'=>$quiz_id,'question_id'=>$question_id]) }}" id="chapter_form" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <!-- style="display:none" -->
                            ...
                            <input type="text" value="{{ $quiz_id }}" name="online_quiz_id" id="online_quiz_id" class="form-control">
                        </div>
