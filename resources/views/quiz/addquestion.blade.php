        ...
        <div class="col-md-8">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form action="{{ route('createQuiz',$chapter_id) }}" id="chapter_form" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <!-- style="display:none" -->
                            ...
                            <input type="text" value="{{ $chapter_id }}" name="quiz_id" id="quiz_id" class="form-control"></textarea>
                        </div>
