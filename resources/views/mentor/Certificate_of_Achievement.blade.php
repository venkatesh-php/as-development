				...
				<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 summary="Layout table" width="100%" style='width:100.0%;border-collapse:collapse'>
 					<tr>
  						<td width="100%" valign=top style='width:100.0%;padding:0in 0in 0in 0in;'>
  							<p class=MsoTitle>Certificate <span class=MsoIntenseEmphasis><span style='color:windowtext;text-transform:none'>of</span></span> Achievement</p>
  							<h1>This Acknowledges That</h1>
  							<div align=center>
  							...
  							<h1>Has Successfully Completed The</h1>
  							<div align=center>
  								<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 summary="Project name" style='border-collapse:collapse'>
   									<tr style='height:2.25in'>
    									<td style='padding:0in .35in 0in 0in;height:0.25in'>
 					...
 					<tr>			
						<td>
							<br><br>
							<div align=center>
								<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 summary="Signature block"  style='border-collapse:collapse;border:none'>
									
									<tr>
										<td style='padding:0in 0in 0in .15in;n'>
											<p class=MsoNormal align=center style='text-align:center'><img width=120 height=70 id="Picture 48" src="{{route('profileImage',['name'=>'s2.jpg'])}}" alt="Placeholder logo"></p>
										</td>
									...
									<tr>
										...
										<td width=100% style='border:none;border-bottom:double #6E6E6E;'>
									...
									<tr>
										...
										<td width=424 valign=top style='width:380pt;border:none;padding:0in 0in 0in 0in;'>
										<p class=MsoSignature><strong><span style='font-size:11.0pt'>Signed</span></strong>,
										<em>Arun Babu Nalamara</em>, CEO, Ameyem Skill Labs</p>
										</td>
									</tr>
								</table>
							</div>
